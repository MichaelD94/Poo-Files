...
namespace AulaAgendaBetim
{
    class Dados
    {
        ...
        {
            TextWriter novoWritter = new StreamWriter(@"C:\Users\Victor\source\repos\AulaAgendaBetim\AulaAgendaBetim\CadastroAlunos.xml");
        ...
        {
            FileStream Arquivo = new FileStream(@"C:\Users\Victor\source\repos\AulaAgendaBetim\AulaAgendaBetim\CadastroAlunos.xml", FileMode.Open);
